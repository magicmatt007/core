...
def configureSlave (newSlaveAddress,newBaudrate,newTransmittionMode,newTermination):
    ...
    newRegisters = [newSlaveAddress,newBaudrate,newTransmittionMode,newTransmittionMode,BusConfigCommand]
    ...
    while (duration <= maxDuration): 
        ...
        try:
            ...
            instrument = minimalmodbus.Instrument(port,slaveAddress)  # port name, slave address (in decimal)  # close_port_after_each_call=False
